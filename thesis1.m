...
%% ====================================================================
%%  FIGURE 7 — BEST-FIT EQUATION DISPLAY  (NEW FIGURE, WHITE BACKGROUND)
%% ====================================================================
...
% Word-wrap the equation at ~75 chars per line
raw_eq  = eq_str;
wrap_w  = 75;
lines_eq = {};
while length(raw_eq) > wrap_w
    % find last space before wrap_w
...
% Feature legend box (bottom area)
...
%% --- Symbolic equation string converter (NEW) --------------------------
